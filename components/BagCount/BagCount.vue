  ...
  >
    ...
    <g>
      <text
        ...
        text-anchor="middle"
      >
        <tspan class="num-items">{{ bagCount }}</tspan>
      </text>
    </g>
  </svg>
</template>
